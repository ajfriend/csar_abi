...
# The JS half of the gate: csar.js against capi's values (via the
# emitted abi.json) and against the built module's export section.
...
ci: check test build wasm gate gate-js
